...
את הצרכים הללו מצאתי ברשת של מהנדסי הדור הבא, שמתמחה בעולם העסקים החינוכי.
...
בברכה, איתי שוסברגר, זכיין (כפר סבא)"
            backgroundColor="red"
          />
          <FTcard
            image={tableimg7}
            heading={`דן לרנר, זכיין (קריית אונו)`}
...
דן לרנר, זכיין (קריית אונו)"
            backgroundColor="yellow"
          />
          <FTcard
            image={tableimg8}
            heading={`שלומי פנסו (מורה)`}
            body="אני עובד עם מהנדסי הדור הבא כבר 10 שנים.
